...
class SplashPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SplashScreen(
      seconds: 7,
      navigateAfterSeconds: new MyHomePage( title: "Almighty Book",),
      //title: new Text('Alimghty Book', style: TextStyle(color:Colors.white),textScaleFactor: 2,),
//image: Image(image: AssetImage("assets/images/splash.gif")),
//photoSize: 300,

//backgroundColor: Colors.black,
//gradientBackground: LinearGradient(colors: [Colors.black38,Colors.blueGrey, Colors.black38,Colors.blueGrey], begin: Alignment.bottomLeft, end: Alignment.topRight),

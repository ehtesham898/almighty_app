...
switch(index) {
  ...
  break;
  case 1: Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FriendDetails(id: widget.id,)));
  break;
  ...
  break;
  case 4: Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FriendDetails(id: widget.id,)));
  break;
  case 5: Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FriendDetails(id: widget.id,)));
  break;
  case 6: Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FriendDetails(id: widget.id,)));
  break;
  ...
  break;
  case 9: Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => FriendDetails(id: widget.id,)));
  break;

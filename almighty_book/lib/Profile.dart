                        ...
                        children: [
                          ...
                          ListTile(
                            ...
                            subtitle: Text(" ${responseFetch['countryCode']} ${responseFetch['phone']}", style: TextStyle(
                                color: Colors.brown, fontSize: 14)),
                            leading: Icon(Icons.phone_iphone, color: Colors.amber,),
                          ),
                          Divider(color: Colors.brown,height: 5,),
                          ListTile(
                          ...
                          preacherType=="Church" ? SizedBox(height: 0,width: 0):Divider(color: Colors.brown,height: 5,),
                         ...
                         Divider(color: Colors.brown,height: 5,),
                          preacherType=="Church" ?  ListTile(
                            ...
                            subtitle: Text("St. Michael", style: TextStyle(
                                color: Colors.brown, fontSize: 14)),
                            leading: Icon(Icons.watch, color: Colors.amber,),
                          ):SizedBox(height: 0,width: 0),
                          preacherType=="Church" ?  Divider(color: Colors.brown,height: 5,):SizedBox(height: 0,width: 0),
                          ...
                          preacherType=="Preacher" ? Divider(color: Colors.brown,height: 5,):SizedBox(height: 0,width: 0),
                          ListTile(
                            ...
                            subtitle: Text("${responseFetch['dob']}", style: TextStyle(
                                color: Colors.brown, fontSize: 14)),
                            leading: Icon(Icons.child_care, color: Colors.amber,),
                          ),
                          Divider(color: Colors.brown,height: 5,),
                        ],
                      ),

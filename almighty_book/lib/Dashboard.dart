  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            DrawerHeader(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                        "Welcome ${widget.name.length > 10 ? widget.name.substring(0, 10) : widget.name}...",
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text("20 Likes",style: TextStyle(
                                              color:
                                              Colors.white)),
                                          Text("34 comments",style: TextStyle(
                                              color:
                                              Colors.white)),
                                        ],
                                      ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.home, color: Colors.brown), title: Text("Home", style: TextStyle(color: Colors.brown),)),
          BottomNavigationBarItem(
              icon: Icon(Icons.library_books,color: Colors.brown), title: Text("Library",style: TextStyle(color: Colors.brown))),
          BottomNavigationBarItem(
              icon: Icon(Icons.account_circle,color: Colors.brown), title: Text("Prayers",style: TextStyle(color: Colors.brown))),
          BottomNavigationBarItem(
              icon: Icon(Icons.help,color: Colors.brown), title: Text("Counselling",style: TextStyle(color: Colors.brown))),
        ],
      ),
